...
namespace utils::hook
{
	...
	void detour::create(void* place, void* target)
	{
		...
		if (status != MH_OK)
		{
			// TEMP DEBUG: this was previously silently swallowed. Print
			// loudly so we can tell whether MinHook actually managed to
			// create a trampoline for this address.
			std::cout << "[HOOK] MH_CreateHook FAILED at " << this->place_
